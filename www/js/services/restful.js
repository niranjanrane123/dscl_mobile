...
angular.module('starter')
  .factory('RestService', function (ENV, $http, $localStorage, $sessionStorage, $rootScope) {
    ...
    api.whatsappUrl="https://wa.me/+911352609200" /* "https://api.whatsapp.com/send?phone=%2B911352609200"; */
...
/*     jal sansthan api   */
api.getJalSansthan = function (ccnNumber) {
  var postData = ccnNumber
  console.log("---postData---" + JSON.stringify(postData))
  return $http.post( api.eipUrl + 'servicePortal/getDoonWaterDetails?connectionNo='+postData).then(function (data) {
    return data.data;
  });
};
    ...
    api.getRecieptDetails = function (postData) {
     ...
     api.EmergencySOSCall = function (postData) {
      ...
      return $http.post(api.eipURL + '/MainetService/rest/api/sos/create', postData).then(function (data) {
        return data.data;
      });
    };
...
// loi loi process payment
    ...
    api.lodgecomplaintsave = function (District, NewCompPincode, NewCompDeptdetails, NewCompType,extReferNumber,landmark,
      NewCompDescription, NewCompLocation, orgid, userID, complaintType, applicantDTO, uploadfinaldata, Latitude, Longitude, 
      referenceMode, rreferenceCategory, rward1, rreferenceDate, rapplnType, ward2
      ) {
      console.log("landmark in restful", landmark)
    ...
    api.getComplantDoc = function (tokenNumber) {
      return $http.post(api.serviceURL + 'mobility/grievance/careRequests/complaintId/' + tokenNumber)
        .then(function (data) {
          return data.data;
        });
    }

    api.getComplaintAttachmentId = function (tokenNumber){
      return $http.post(api.serviceURL + 'newGrievance/careRequests/complaintId/' + tokenNumber)
        .then(function (data) {
          return data.data;
        });
    }
  ...
  return $http.post(api.cxfServiceUrl + 'rest/citizenDashboard/getLoiInformation', params).then(function (data) {
    ...
    api.getAccessToken = function () {
      var params = {
          ...
          "authorizationKey": "R3RFeVV3ZTI3YTh6NUQ0cU1KQ2Z0dTFPZUVZYTozVzlWaHdrTzBsc0dFdUExZG8wb1JXbGZZRUFh]",
          "username":"abm",
    ...
    api.getComplaintList = function (phonNo) {
      ...
      //var url = api.swmURL + 'trinityswm/1.0.0/swm/getComplaintList?phoneNo=' + phonNo;    //Defect. #186225
...
api.getOnGoingProjects = function (end) {
  ...
  return $http.get(url).then(function (data) {
    ...
    api.getEnviornmentData = function (mackid, fromDate, toDate, time) {
      //var url = api.enviornmentURL + 'Environment/1.0.0/Environment/getEnvironmentData?macid=' + mackid;          //Old API
      var url = api.enviornmentURL + 'Environment/1.0.0/Environment/getEnvironmentData?fromdate=' + fromDate + '%20' + time + '&todate=' + toDate + '%20' + time + '&columns=CO2&macid=' + mackid + '&limit=1';            //New API   //Limit changed to 1 from 5 for simplicity of data
      console.log("uRL----" + url);
      return $http.get(url, {
    ...
    api.getEnvironmentAvg = function (data) {
const url = `https://dscliothub.uk.gov.in/api/trinityENV/1.0.0/getAvg?${data}`;
 return $http.get(url, {
        //headers: { 'Authorization': "Bearer " + token }
        headers: { 'Authorization': "Bearer" +  " " + " " + $rootScope.swmAccessTokenEnv }
      }).then(function (data) {
  ...
  // const config = {
  //   headers: { 
  //     'Authorization': "Bearer " + $rootScope.swmAccessTokenEnv 
  //   },
  ...
  // };
    ...
    api.getPropertyTaxId = function (challanId) {
      // var header = cordova.plugin.http.getBasicAuthHeader('user', 'password');
     var url =  api.eipUrl + 'servicePortal/searchPropertyTax?consumerCode='+ challanId +'&tenantId=uk.dehradun&businessService=PT'
     return $http.post(url).then(function (data) {
      return data.data;
    });
     ...
     api.getPropertyTaxToken = function () {
      ...
      return $http.post(url, {
        headers: { 'Authorization': 'Bearer ZWdvdi11c2VyLWNsaWVudDplZ292LXVzZXItc2VjcmV0' }
      }).then(function (data) {
        return data;
      });
    ...
    api.nearByBusStops = function (params,token) {
      var url = api.swmURL + 'trinityITMS/1.0.0/ITMS/nearByStops';
      return $http.post(url, params, {
        headers: { 'Authorization': "Bearer" +  " " + " " + token } //$rootScope.swmAccessTokenData
      }).then(function (data) {
        return data;
      });
    };

    api.arrivingBusesList = function (params,token) {
      // http://IP:PORT/ITMS/timeTableDetails
    ...
    api.enroutedDetails = function (params,token) {
      // http://IP:PORT/ITMS/timeTableDetails 
    ...
    api.tripPlannerDetails = function (params,token) {
    ...
    api.getRouteTypes = function (token) {
      // http://IP:PORT/trinityITMS/1.0.0/ITMS/timeTableDetails
      var params = {
        "routeName": "R100"
      }
    ...
    api.timeTableDetails = function (params,token) {
      // http://IP:PORT/trinityITMS/1.0.0/ITMS/timeTableDetails
    ...
    api.routeDetails = function (token) {
      // http://IP:PORT/trinityITMS/1.0.0/ITMS/timeTableDetails
      var params = {
        "routeId": 9617
      }
    ...
    api.wayPointsDetails = function (params,token) {
      // http://IP:PORT/trinityITMS/1.0.0/ITMS/timeTableDetails
      // var params = {
      //   "routeId": 8579, "fleetId": 134
      // }
...
//No longer in Use, for Defect. #208213
    api.getYourWardZoneByLoc = function (latitude,longitude) {
      
      // var token = "Bearer" + " " + "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJVc2VyIjoiZGVocmFkdW4iLCJQYXNzd29yZCI6ImFkbWluQDEyMyIsIlByb2plY3QiOiJzYzEwX2RlaHJhZHVuX3BnIiwiSG9zdCI6IjEwLjY3LjE3MS40NyIsIlBvcnQiOjU0MzIsInR5cGUiOiJQcm9mZXNzaW9uYWwiLCJpYXQiOjE2MTkyNjQxNzMsImF1ZCI6InNnbDpQcm9mZXNzaW9uYWwiLCJpc3MiOiJzZ2wudGxkIn0.qiQihyNiwE6H2XVEa11aWxN3AhFK9U6aCRPFUUYtb30cn9jc4yeTAt4I2jOp5sX3qlsYKNRtB2nkGGSUn7bBm6J33HFQC692LjRaDeTszI6BcNmGJTD9Ewr9nEDJY_0EUub0hC5uafVt0i4kZbCB6saW4P1vRzyGeO7WwKeEuBw"   //Bearer Change for Defect #172444
      var token = "Bearer" + " " + "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJVc2VyIjoiRFNDTCIsIlBhc3N3b3JkIjoiQXNkQDEyMzQiLCJQcm9qZWN0Ijoic2MxMF9kZWhyYWR1bl9wZyIsIkhvc3QiOiIxMC42Ny4xNzEuNDciLCJQb3J0Ijo1NDMzLCJ0eXBlIjoiUHJvZmVzc2lvbmFsIiwiaWF0IjoxNjcxNzMzNTQ4LCJhdWQiOiJzZ2w6UHJvZmVzc2lvbmFsIiwiaXNzIjoic2dsLnRsZCJ9.Oxo4Qj4n_RQ9gSp-x2MsqDJlt2GJ5aVTecRZfWVO0M5baQAyvLsQgDk-QtC5Rw5dulfWqOutOoIhR5OP8XajCQMPFtZScPmXnHboZvQc1zDiiCurajlp4dLLaFtIEAhjLMzg84ARBKbfDB4ZNR4Hhy9pHrcN59EJk8o44FZxawo"
    ...
    api.getYourWardZoneByLocNew = function(latitude,longitude) {
      console.log("In restfull lat long",latitude,longitude)
      var url = 'https://dsclgis.uk.gov.in:8443/IGISRest_API/Geocoder/GetAttributeValueFromLayer/landmark/'+ longitude + '/' + latitude + '/10?SelectAttributes=*&NumberOfResults=10'
      // var url = 'https://dsclgis.uk.gov.in:8443/IGISRest_API/Geocoder/GetAttributeValueFromLayer/landmark/78.002083000095/30.3020429999517/10?SelectAttributes=*&NumberOfResults=10'
      console.log(url,"my url location....");

      return $http.get(url,{
        headers: { 'Authorization': 'Bearer ' + ENV.gisToken}
      }).then(function (data) {
        return data.data;
      });token
    }
    ...
    api.getYourNearByPlaces = function (param1,param2,distance,recordNo,latitude,longitude) {
      ...
      //var token = "Bearer" + " " + "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJVc2VyIjoiZGVocmFkdW4iLCJQYXNzd29yZCI6ImFkbWluQDEyMyIsIlByb2plY3QiOiJzYzEwX2RlaHJhZHVuX3BnIiwiSG9zdCI6IjEwLjY3LjE3MS40NyIsIlBvcnQiOjU0MzIsInR5cGUiOiJQcm9mZXNzaW9uYWwiLCJpYXQiOjE2MTkyNjQxNzMsImF1ZCI6InNnbDpQcm9mZXNzaW9uYWwiLCJpc3MiOiJzZ2wudGxkIn0.qiQihyNiwE6H2XVEa11aWxN3AhFK9U6aCRPFUUYtb30cn9jc4yeTAt4I2jOp5sX3qlsYKNRtB2nkGGSUn7bBm6J33HFQC692LjRaDeTszI6BcNmGJTD9Ewr9nEDJY_0EUub0hC5uafVt0i4kZbCB6saW4P1vRzyGeO7WwKeEuBw" //Bearer Change for Defect #172444
      //var token = "Bearer" + " " + "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJVc2VyIjoiRFNDTCIsIlBhc3N3b3JkIjoiQXNkQDEyMzQiLCJQcm9qZWN0Ijoic2MxMF9kZWhyYWR1bl9wZyIsIkhvc3QiOiIxMC42Ny4xNzEuNDciLCJQb3J0Ijo1NDMzLCJ0eXBlIjoiUHJvZmVzc2lvbmFsIiwiaWF0IjoxNjcxNzMzNTQ4LCJhdWQiOiJzZ2w6UHJvZmVzc2lvbmFsIiwiaXNzIjoic2dsLnRsZCJ9.Oxo4Qj4n_RQ9gSp-x2MsqDJlt2GJ5aVTecRZfWVO0M5baQAyvLsQgDk-QtC5Rw5dulfWqOutOoIhR5OP8XajCQMPFtZScPmXnHboZvQc1zDiiCurajlp4dLLaFtIEAhjLMzg84ARBKbfDB4ZNR4Hhy9pHrcN59EJk8o44FZxawo"
      var token = "Bearer" + " " + "eyJhbGciOiJSUzUxMiIsInR5cCI6IkpXVCJ9..NxmUq2oit6GxUcmS6Lx1e1ZSiN1OPeyl8lcO4He-hgW8M0JclHfobpTBZbYbP27fmPzmQW2eJ07o63wcVV96cTVHw61hlGkC5JrUM7eVoirER7YTRIQU9-IXiW3dofK0SPo3NFBGBvcLYO8797IdCqTqP2o5Sq1f_qYN12EmU3U"
      ...
      var url = 'https://dsclgis.uk.gov.in:8443/IGISRest_API/Geocoder/GetLocationsFromAttribute/'+param1+'/'+param2+'/'+latitude+'/'+longitude+'/'+distance+'/'+recordNo;
    ...
    api.getYourNearByPlacesNew = function (mapValue) {
      
      var url = 'https://dsclgis.uk.gov.in:8443/IGISRest_API/MetaData/GetLayerData/' + mapValue;
      console.log(url,"my url location....")
    ...
    //Defect #163040 start
    api.getTrafficSignalListStatic = function(){
      var url = ENV.trafficURL + 'utmc/traffic_signal/static?xml=false&page_num=1&page_len=50';
        return $http.get(url, {
          headers: { 'auth-client': "LSCL", 'auth-licence': "ccT0F804bU8093N3900I5ff4Sfe49Ob58aS3b" }
        }).then(function (data) {
          return data.data;
        });
    }
    ...
    //Enhancement #183156 start
    api.getTrafficSignalListDynamic = function(){
      // var url = ENV.trafficURL + 'utmc/traffic_signal/dynamic?page_num=1&page_len=100';
        var url = ENV.trafficURL + 'utmc/traffic-signal/dynamic?xml=false&history=false';
        return $http.get(url, {
          headers: { 'auth-client': "LSCL", 'auth-licence': "ccT0F804bU8093N3900I5ff4Sfe49Ob58aS3b" }
        }).then(function (data) {
          return data.data;
    ...
    //Enhancement #183156 end

//UPCL View Bill Start

    api.getUPCLBillDetails = function(accountNo){
      var url = ENV.upclURL + 'wssservices/api/v1/externalBillDetails?accountNumber=' + accountNo;
        return $http.get(url, {
          headers: { 'did': "849fecb23fd5795266cff42731c82873", 'serviceKey': "D20LUPCL22849" }
        }).then(function (data) {
          return data.data;
        });
    }

    api.getUPCLBillDownload = function(accountNo){
      var url = ENV.upclURL + 'wssservices/api/v1/externalDownloadBill?accountNumber=' + accountNo;
        return $http.get(url, {
          headers: { 'did': "849fecb23fd5795266cff42731c82873", 'serviceKey': "D20LUPCL22849" }
        }).then(function (data) {
          return data.data;
    ...
    //RTI First Appeal
    api.getReferenceData=function(paramData){
      return $http.post( api.brmsurl+'services/rest/common/objection/getApplicantDetails',paramData).then(function(data){
        return data.data;
      });
    };
    api.getListOfXML=function(){
      return $http.get('https://dsclgis.uk.gov.in:8443/cgi-bin/IGiS_Ent_service.exe?IEG_PROJECT=dehradun_ws&service=wms&request=GetCapabilities&version=1.3.0').then(function(data){
        return data.data;
      });
    };
    api.getDeptForFirstAppeal = function (params) {
      console.log("Dep First Appeal",params)
      return $http.post( api.brmsurl + "services/rest/common/objection/getDepartmentList", params)
        .then(function (data) {
          return data.data;
        });
    };
    
    api.getServiceForFirstAppeal = function (params) {
      console.log("Service First Appeal",params)
      return $http.post( api.brmsurl + "services/rest/common/objection/getservicesByDeptId", params)
        .then(function (data) {
          return data.data;
        });
    };

    api.getLocForFirstAppeal = function (params) {
      console.log("Location First Appeal",params)
      return $http.post( api.brmsurl + "services/rest/common/objection/getLocationList", params)
        .then(function (data) {
          return data.data;
        });
    };

    api.saveFirstAppeal = function (params) {
      console.log("Save First Appeal",params)
      return $http.post( api.brmsurl + "services/rest/common/objection/saveObjection", params)
        .then(function (data) {
          return data.data;
        });
    };
    api.getMemberProfileDetails = function (idOne,idTwo) {
      return $http.get( `${api.eipUrl}citizenAPI/getProfile/${idOne}/${idTwo}`)
        .then(function (data) {
          return data.data;
        });
    };

     api.getEbusTTandPrice = function (id) {
      console.log("Save First Appeal",id)
      return $http.get( api.eipUrl + `citizenAPI/getDetailQuickLinkData/${id}/1`)
        .then(function (data) {
          return data.data;
        });
    };
