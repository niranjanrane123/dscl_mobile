...
angular.module('starter')
  ...
  .controller('FeedbackCtrl', function ($rootScope, $scope, $localStorage, $ionicPlatform, $ionicPopup, RestService, $ionicLoading, $stateParams, toaster, $filter, ENV, $state,$sessionStorage) {
...
if($sessionStorage.comeFrom == "ebus")
{
