...
datePicker.controller('EstateBookPropCtrl', function ($scope, RestService, $ionicLoading, $stateParams, toaster, $filter, ENV,
$state, $rootScope,$stateParams,$localStorage,$sessionStorage){
	var disabledDates = [];
