angular.module('starter')
  ...
  .controller('plbUploadCTRL', function ($rootScope,$scope, $location, RestService, $ionicLoading, $stateParams, toaster,
...
console.log("$sessionStorage.applmeterread--"+$sessionStorage.applmeterread);
   ...
   if($sessionStorage.setDependentResponse.free){
           ...
           RestService.servicecharge(
              ...
              $sessionStorage.wrusageSubtype1,
...
_init();
         ...
         var savePlumber = function(){
            $sessionStorage.plumberData.documentList = $sessionStorage.documentObjectArray;
            $ionicLoading.show({	template:$filter('translate')('LOADING')	});
