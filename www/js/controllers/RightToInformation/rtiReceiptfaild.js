angular.module('starter')
 ...
 .controller('rtifaildReceiptctrl', function ($scope, RestService, $ionicLoading, $stateParams,
...
//		$scope.orgid = $localStorage.responselogindata.orgId;
    ...
    $scope.cancelPayment = false;
    	...
    	$scope.getTransactionAfterPaymentfail = function (){
...
$scope.canvas;
 ...
 $scope.homepage = function()
 {
  ...
  $state.go("app.home");
    ...
    $scope.getTransactionAfterPaymentfail()
