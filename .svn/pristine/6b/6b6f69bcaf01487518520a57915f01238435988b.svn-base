...
module.exports = [
  ...
  {
    "id": "cordova-in-app-update.UpdatePlugin",
    "file": "plugins/cordova-app-update-plugin/www/updatePlugin.js",
    "pluginId": "cordova-in-app-update",
    "clobbers": [
      "window.plugins.updatePlugin"
    ]
  }
];
